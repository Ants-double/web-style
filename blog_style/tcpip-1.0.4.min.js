  ...
  return (function (t) {
            ...
            a(e, [
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    (this._dom = (0, c.createElement)(t, e)),
    ...
    function (t, e, n) {
      ...
      function i(t, e) {
        ...
        for (var r in t)
          if ("style" !== r) n[r] = t[r];
          else for (var i in t[r]) n.style[i] = t[r][i];
        return n;
      }
      function o(t, e) {
        return (
            ...
            a(e, [
              {
                ...
                value: function () {
                  ...
                  this.createDom({
                    ...
                    (this._btnBox = new f.default(this.config, this)),
                    (this._mainBox = new h.default(this.config, this));
                },
              },
              {
                key: "show",
    ...
    function (t, e, n) {
      "use strict";
      function r(t) {
        void 0 === t.stat && (t.stat = u), t.top || (t.top = a), i(t), o(t);
      }
      function i(t) {
        t.button || (t.button = c);
        var e = t.button;
        e.imageUrl ||
          (e.id || (e.id = c.id),
          (e.type && (0, A.inArray)(e.type, s)) || (e.type = c.type),
          (e.imageUrl = f[e.type][e.id]),
          delete e.type,
          delete e.id);
      }
      function o(t) {
        ...
        try {
          for (
            var a, u = t.list[Symbol.iterator]();
            !(r = (a = u.next()).done);
            r = !0
          ) {
            var s = a.value;
            if (!s.type) {
              console.error("缺少type，相应配置文件为", s);
              break;
            }
            if (!s.qrImg && !s.qrContent) {
              console.error("缺少qrImg或者qrContent参数，相应配置文件为", s);
              break;
            }
            var c = s.type;
            if (
              (l.hasOwnProperty(c) && (0, A.mergeObject)(s, l[c], !0),
              n ? (s.active = "") : s.active && (n = !0),
              (s.index = e.length),
              e.push(s),
              e.length >= 5)
            )
                  ...
                  this.createDom(
                    {
                      ...
                      onclick: function () {
                        "240px" === t.parentDom.dom.style.width
                          ? t.parentDom.hide()
                          : t.parentDom.show();
                      },
                      href: "javascript:;",
                    ...
                    (this._button = new f(this.config, this));
                },
              },
            ]),
            e
            ...
            a(e, [
              {
                ...
                value: function () {
                  this.createDom({ className: "tctip-main-box" }),
                    (this._title = new f.default({}, this)),
                    (this._bodyBox = new h.default(
            ...
            a(e, [
              {
                ...
                value: function () {
                  this.createDom({ className: "tctip-body-box" }),
                    (this._iconBox = new f.default(
                      { list: this.config.list },
                      this
                    )),
                    (this._QRDetail = new h.default(this.currentItem, this));
                },
              },
              {
                key: "currentItem",
      ...
      var u = (function () {
                ...
                value: function () {
                  ...
                  try {
                    for (
                      ...
                      var o = r.value;
                      this._iconDoms.push(new b(o, this));
                    }
                  } catch (t) {
                    (e = !0), (n = t);
                  } finally {
            ...
            u(e, [
              {
                ...
                value: function () {
                  this.createDom({ className: this.className }, "li"),
                    (this._link = new d(this.config, this));
                },
              },
              {
                key: "addEvent",
        ...
        d = (function (t) {
          function e(t, n) {
            ...
            return (r._img = void 0), (r._emitter = h.default), r.genDom(), r;
          }
          return (
            a(e, t),
            u(e, [
            ...
            u(e, [
              {
                ...
                value: function () {
                  this.createDom({ className: "tctip-qr-detail" }),
                    (this._box = new d(this.config, this));
                },
              },
            ]),
            e
              ...
              },
              {
                ...
                value: function () {
                  (this._qrTitle = new y({}, this)),
                    (this._qrCode = new v(this.config, this)),
                    (this._qrDesc = new m(
              ...
              },
              {
                ...
                value: function () {
                  this.config.qrImg
                    ...
                    ? (this.dom.innerHTML = (0, h.default)(
                        this.config.qrContent
                      ))
            ...
            u(e, [
              {
                ...
                value: function () {
                  this.createDom(
                    i({ className: "tctip-title" }, f.textKey, "喜欢请打赏"),
                    "h1"
                  );
                },
              },
    ...
    function (t, e, n) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.default = function (t) {
          ...
          return e.addData(t), e.make(), e.createImgTag(s, u);
        });
      var i = n(21),
        o = r(i),
        A = "L",
    ...
    function (t, e, n) {
      (e = t.exports = n(19)()),
        e.push([
          t.i,
          "._3kqVhI7koswafX9AL9ZzT5{position:fixed;right:0;z-index:10000;padding-left:34px;width:0;overflow:hidden;box-sizing:content-box;background-color:transparent}._3kqVhI7koswafX9AL9ZzT5 li,._3kqVhI7koswafX9AL9ZzT5 ul{margin:0;padding:0}._3kqVhI7koswafX9AL9ZzT5 img{border:0;display:block}._3kqVhI7koswafX9AL9ZzT5 a{color:#000;text-decoration:none;outline:0 none}._3kqVhI7koswafX9AL9ZzT5 ._393ue_MIIoN-dGbYvJ9n_a{position:absolute;left:0;top:50%;margin-top:-46px;width:34px;height:93px}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi{width:240px;height:332px;font:12px/1.5 microsoft yahei,tahoma,arial,sans-serif;color:#000;background-color:#fff;border:1px solid #dbdbdb;border-right:none}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._3-RUxA2XB_sBbfpZBPtdCs,._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi .WVKGQ2HhWpMNwwApuB3WX{margin:0;height:26px;line-height:26px;background-color:#e7e7e7}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._3-RUxA2XB_sBbfpZBPtdCs{padding:0 0 0 6px;font-size:14px;font-weight:400;background-image:none}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi .WVKGQ2HhWpMNwwApuB3WX{padding-right:6px;font-size:12px;text-align:right}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi .WVKGQ2HhWpMNwwApuB3WX a:hover{text-decoration:underline}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY{font-size:0;background-color:#eee;width:240px}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY ._1pSCODu_CYm6MNf_XEgQmL{display:inline-block;vertical-align:middle;width:90px;font-size:12px}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY ._1pSCODu_CYm6MNf_XEgQmL ul{list-style:none}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY ._1pSCODu_CYm6MNf_XEgQmL ul a.g1rgkQUP8C68-5ls4SLSC{border-bottom:none}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY ._1pSCODu_CYm6MNf_XEgQmL ul._2sXTjCr9wSML9z4RKLcIQa{border-top:1px solid #dfdfdf}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY ._1pSCODu_CYm6MNf_XEgQmL ul li{display:block;height:56px;-webkit-transition:background-color .2s linear;transition:background-color .2s linear}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY ._1pSCODu_CYm6MNf_XEgQmL ul li._1v0XmA4zNmO9rtYhzj6ydE{border-right:none}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY ._1pSCODu_CYm6MNf_XEgQmL ul li._1v0XmA4zNmO9rtYhzj6ydE a,._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY ._1pSCODu_CYm6MNf_XEgQmL ul li._1v0XmA4zNmO9rtYhzj6ydE a:hover{background-color:#fff}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY ._1pSCODu_CYm6MNf_XEgQmL ul li a{position:relative;display:block;padding-left:40px;height:55px;line-height:55px;font-size:12px;border-bottom:1px solid #ccc}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY ._1pSCODu_CYm6MNf_XEgQmL ul li a img{position:absolute;left:6px;top:13px;width:30px;height:30px}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY .q6VTlRZo8W0h2bIfMHh6Y{display:inline-block;vertical-align:middle;width:150px;height:280px;font-size:12px;background-color:#fff}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY .q6VTlRZo8W0h2bIfMHh6Y ._1xInAwSNQFxWUVDFINqafy{padding:14px 0 0 10px}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY .q6VTlRZo8W0h2bIfMHh6Y ._1xInAwSNQFxWUVDFINqafy ._140JHFXYjznrXaFVMP8asR{margin:0 0 20px;width:132px;height:30px;line-height:30px;font-size:12px;text-align:center}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY .q6VTlRZo8W0h2bIfMHh6Y ._1xInAwSNQFxWUVDFINqafy ._31zfo6T2PgYXgwbcnJL7WZ{margin:0 0 20px;padding:12px;width:106px;height:106px;background:url(" +
            n(23) +
            ") no-repeat;box-sizing:content-box}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY .q6VTlRZo8W0h2bIfMHh6Y ._1xInAwSNQFxWUVDFINqafy ._31zfo6T2PgYXgwbcnJL7WZ img{width:106px;height:106px}._3kqVhI7koswafX9AL9ZzT5 ._3QbjJvr7yqYqZ4hpLAtbEi ._9b_QACxN6kkbAoNbmspCY .q6VTlRZo8W0h2bIfMHh6Y ._1xInAwSNQFxWUVDFINqafy ._3szugzX5Kxgl6JNlPC24LW{font-size:12px;word-break:break-all;text-align:center}",
          "",
        ]),
        (e.locals = {
          tctip: "_3kqVhI7koswafX9AL9ZzT5",
          "tctip-btn-box": "_393ue_MIIoN-dGbYvJ9n_a",
          "tctip-main-box": "_3QbjJvr7yqYqZ4hpLAtbEi",
          "tctip-title": "_3-RUxA2XB_sBbfpZBPtdCs",
          "tctip-footer": "WVKGQ2HhWpMNwwApuB3WX",
          "tctip-body-box": "_9b_QACxN6kkbAoNbmspCY",
          "tctip-icon-box": "_1pSCODu_CYm6MNf_XEgQmL",
          fifth: "g1rgkQUP8C68-5ls4SLSC",
          "not-full": "_2sXTjCr9wSML9z4RKLcIQa",
          "tctip-current": "_1v0XmA4zNmO9rtYhzj6ydE",
          "tctip-qr-detail": "q6VTlRZo8W0h2bIfMHh6Y",
          "tctip-qr-box": "_1xInAwSNQFxWUVDFINqafy",
          "tctip-qr-title": "_140JHFXYjznrXaFVMP8asR",
          "tctip-qr-code": "_31zfo6T2PgYXgwbcnJL7WZ",
          "tctip-qr-desc": "_3szugzX5Kxgl6JNlPC24LW",
        });
    },
    function (t, e) {
      t.exports = function () {
        ...
        A = (function () {
          ...
          var e = function (e, n) {
            var i = 236,
              ...
              R = function () {
                for (var t = 8; t < b - 8; t += 1)
                  null == g[t][6] && (g[t][6] = t % 2 == 0);
                for (var e = 8; e < b - 8; e += 1)
                  null == g[6][e] && (g[6][e] = e % 2 == 0);
              },
              M = function () {
                for (
                  var t = o.getPatternPosition(h), e = 0;
                  e < t.length;
                  e += 1
                )
              ...
              k = function (t) {
                for (var e = o.getBCHTypeNumber(h), n = 0; n < 18; n += 1) {
                  var r = !t && 1 == ((e >> n) & 1);
                  g[Math.floor(n / 3)][(n % 3) + b - 8 - 3] = r;
                }
                for (var n = 0; n < 18; n += 1) {
                  var r = !t && 1 == ((e >> n) & 1);
                  g[(n % 3) + b - 8 - 3][Math.floor(n / 3)] = r;
                }
              },
              D = function (t, e) {
                for (
                  var n = (p << 3) | e, r = o.getBCHTypeInfo(n), i = 0;
                  i < 15;
                  i += 1
                ) {
                  var A = !t && 1 == ((r >> i) & 1);
              ...
              B = function (e, n) {
                for (
                  ...
                  for (var l = 0; l < a[s].length; l += 1)
                    a[s][l] = 255 & e.getBuffer()[l + r];
                  r += c;
                  var h = o.getErrorCorrectPolynomial(f),
                    p = t(a[s], h.getLength() - 1),
                    g = p.mod(h);
                  u[s] = new Array(h.getLength() - 1);
                  for (var l = 0; l < u[s].length; l += 1) {
                    var b = l + g.getLength() - u[s].length;
                    u[s][l] = b >= 0 ? g.getAt(b) : 0;
                  }
                }
                for (var d = 0, l = 0; l < n.length; l += 1)
                  d += n[l].totalCount;
                for (var y = new Array(d), v = 0, l = 0; l < i; l += 1)
                  for (var s = 0; s < n.length; s += 1)
                    l < a[s].length && ((y[v] = a[s][l]), (v += 1));
                for (var l = 0; l < A; l += 1)
                  for (var s = 0; s < n.length; s += 1)
                    l < u[s].length && ((y[v] = u[s][l]), (v += 1));
                return y;
              },
              Z = function (t, e, n) {
                for (
                  var r = a.getRSBlocks(t, e), s = u(), c = 0;
                  c < n.length;
                  c += 1
                ) {
                  var f = n[c];
                  s.put(f.getMode(), 4),
                    s.put(f.getLength(), o.getLengthInBits(f.getMode(), t)),
                    f.write(s);
                }
                ...
                for (;;) {
                  ...
                  if ((s.put(i, 8), s.getLengthInBits() >= 8 * l)) break;
                  s.put(A, 8);
                }
                return B(s, r);
              };
            return (
              ...
              (m.createSvgTag = function (t, e) {
                ...
                for (
                  ...
                  for (o = i * t + e, n = 0; n < m.getModuleCount(); n += 1)
                    m.isDark(i, n) &&
                      ((r = n * t + e), (u += "M" + r + "," + o + A));
                return (
                  (u += '" stroke="transparent" fill="black"/>'),
                  (u += "</svg>")
                );
              }),
          ...
          var n = {
              ...
              return (
                ...
                (a.getLostPoint = function (t) {
                  ...
                  for (var c = 0, i = 0; i < e; i += 1)
                    for (var r = 0; r < e; r += 1) t.isDark(r, i) && (c += 1);
                  return (n += 10 * (Math.abs((100 * c) / e / e - 50) / 5));
                }),
                a
              );
            })(),
            ...
            b = function (t, e) {
              ...
              var A = function (t) {
                ...
                a = function (t) {
                  for (
                    var e = 1 << t, n = (1 << t) + 1, r = t + 1, o = u(), a = 0;
                    a < e;
                    a += 1
                  )
                  ...
                  c.write(e, r);
                  var f = 0,
                    l = String.fromCharCode(i[f]);
                  for (f += 1; f < i.length; ) {
                    var p = String.fromCharCode(i[f]);
                    (f += 1),
                      o.contains(l + p)
                        ? (l += p)
                        : (c.write(o.indexOf(l), r),
                          o.size() < 4095 &&
                            (o.size() == 1 << r && (r += 1), o.add(l + p)),
                          (l = p));
                  }
                  return (
                    c.write(o.indexOf(l), r),
            ...
            d = function (t, e, n, r) {
              for (var i = b(t, e), o = 0; o < e; o += 1)
                for (var A = 0; A < t; A += 1) i.setPixel(A, o, n(A, o));
              var a = h();
              i.write(a);
              for (
                var u = p(), s = a.toByteArray(), c = 0;
                c < s.length;
                c += 1
              )
                u.writeByte(s[c]);
    ...
    function (t, e, n) {
            ...
            a(e, [
              {
                key: "formatConfig",
                value: function () {
                  (0, s.formatConfig)(this._config);
                },
              },
              {
                key: "getTctipDom",
                value: function () {
                  this._tctipDom = new h.default(this._config);
                },
              },
              {
                key: "stat",
      ...
      (d.version = b), (e.default = d), (t.exports = e.default);
    },
  ]);
});
